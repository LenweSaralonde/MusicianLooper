...
local msg = MusicianLooper.InitLocale("fr", "Français", "frFR")

------------------------------------------------------------------------
---------------- ↑↑↑ DO NOT EDIT THE LINES ABOVE ! ↑↑↑  ----------------
------------------------------------------------------------------------

msg.ERROR_MUSICIAN_VERSION_TOO_OLD = "Votre version de Musician est trop ancienne pour Musician Looper. Veuillez mettre à jour."
msg.ERROR_MUSICIAN_LOOPER_VERSION_TOO_OLD = "Votre version de Musician Looper est trop ancienne. Veuillez mettre à jour."