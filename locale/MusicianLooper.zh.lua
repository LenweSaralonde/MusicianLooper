...
local msg = MusicianLooper.InitLocale("zh", "中文", "zhCN")

------------------------------------------------------------------------
---------------- ↑↑↑ DO NOT EDIT THE LINES ABOVE ! ↑↑↑  ----------------
------------------------------------------------------------------------

msg.ERROR_MUSICIAN_VERSION_TOO_OLD = "你的Musician版本太旧以致不能使用Musician Looper，请升级。"
msg.ERROR_MUSICIAN_LOOPER_VERSION_TOO_OLD = "您的 Musician Looper 版本太旧。 请更新它。"