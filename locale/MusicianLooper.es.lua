...
local msg = MusicianLooper.InitLocale("es", "Español", "esES", "esMX")

------------------------------------------------------------------------
---------------- ↑↑↑ DO NOT EDIT THE LINES ABOVE ! ↑↑↑  ----------------
------------------------------------------------------------------------

msg.ERROR_MUSICIAN_VERSION_TOO_OLD = "Su versión de Musician es demasiado antigua para Musician Looper. Actualícelo."
msg.ERROR_MUSICIAN_LOOPER_VERSION_TOO_OLD = "Su versión de Musician Looper es demasiado antigua. Actualízalo."