...
local msg = MusicianLooper.InitLocale("de", "Deutsch", "deDE")

------------------------------------------------------------------------
---------------- ↑↑↑ DO NOT EDIT THE LINES ABOVE ! ↑↑↑  ----------------
------------------------------------------------------------------------

msg.ERROR_MUSICIAN_VERSION_TOO_OLD = "Deine Version von Musician ist zu alt für Musician Looper. Bitte aktualisieren."
msg.ERROR_MUSICIAN_LOOPER_VERSION_TOO_OLD = "Ihre Version von Musician Looper ist zu alt. Bitte aktualisieren Sie es."